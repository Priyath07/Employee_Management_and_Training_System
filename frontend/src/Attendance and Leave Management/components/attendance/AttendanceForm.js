...
function AttendanceForm() {
  ...
  // URL to your AttendanceForm
  const formURL = 'http://localhost:3000/AttendanceForm'; // Update with your actual URL
      ...
      <div className='middlein'>
        <div className='card'>
          <div className='card-body'>
            ...
            <div>
              <h3>Scan QR Code to Access the Form</h3>
              <QRCode value={formURL} size={128} />
            </div>
          </div>
        </div>
      </div>
