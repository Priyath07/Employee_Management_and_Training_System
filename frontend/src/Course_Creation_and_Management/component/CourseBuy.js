...
function CourseBuy() {
    ...
    const courseOptions = [
        { id: 'IT2090', name: 'Software Engineer' },
        { id: 'IT2080', name: 'UI/UX Design' },
        { id: 'IT2050', name: 'Data Science' },
        { id: 'IT2060', name: 'Cyber Security' },
    ...
    const handleFormSubmit = async (e) => {
        ...
        if (Object.keys(errors).length === 0) {
            ...
            if (isConfirmed) {
                try {
                    const response = await axios.post('http://localhost:8050/Course_Creation_and_Management/CoursePayment/coursePaymentAdd', formData);
    ...
    return (
        <><br></br><br></br><div className="form-container">
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <button type="submit" className="btn btn-success" style={{ width: '150px', height: '40px' }}>
                    Submit Payment
                </button>
                <br />
                <br />
                <Link to="/coursePaymentAll" className="btn btn-info" style={{ width: '150px', height: '40px' }}>
                    Details
                </Link>
            </form>
            <Report />
